...
// BackendPro JS
$config['asset'][] = array('file'=>'http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js', 'name'=>'jquery');
...
//jquery quicksand
//$config['asset'][] = array('file'=>'jquery.quicksand.min.js', 'needs'=>'jquery');
...
$config['asset_group']['ADMIN'] = 'bep_admin_layout|bep_admin_style|FlashStatus|forms|buttons|bep_navigation|treeview|bep_icons|bep_select_all|anytime|anytimestyle|anytimetz';

// Added from here 
$config['asset_group']['SHOP'] = 'FlashStatus|webshop|menu.init|jquery.colorbox-min|colorbox|fitness|shopcustomtools|fitnessjs';
$config['asset_group']['SHOPADMIN'] = 'jquery_ui|admin|shoutbox|master|jquery.datepick|jquery.datepick.pack|coda|site|jquery.dataTables.min|jquery.accordion|demo_table|jqaccordion|jquery.colorbox-min|colorbox|jquery.timePicker.min|timePicker|fitness|fitness_admin';
