$(document).ready(function(){
	...
	$("#form").submit(function(event){
		...
		if(checkForm()){
			//var nick = inputUser.attr("value");// you don't need this
			//var message = inputMessage.attr("value");// you don't need this
			...
			$.ajax({
				...
				data: $('#form').serialize(),
				complete: function(data){
					//messageList.html(data.responseText);// you don't need this
					updateShoutbox();
					 $('#message').val('');
